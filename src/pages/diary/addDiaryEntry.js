          ...
          <IonRow>
            <IonCol size="4">
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  placeholder="Enter Litres of Water Drank"
                  value={litresWater}
                  type="number"
                  required
                  onIonChange={(e) => setLitresWater(e.detail.value)}
                ></IonInput>
              </IonItem>
            </IonCol>
            ...
            <IonCol size="4">
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  ...
                  type="number"
                  required
                  onIonChange={(e) => setSteps(e.detail.value)}
                ></IonInput>
              </IonItem>
            </IonCol>
            ...
            <IonCol size="4">
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  ...
                  type="text"
                  required
                  onIonChange={(e) => setHrsSleep(e.detail.value)}
                ></IonInput>
              </IonItem>
            </IonCol>
          </IonRow>
            ...
            <IonCol>
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  ...
                  type="text"
                  required
                  onIonChange={(e) => setBreakfastCal(e.detail.value)}
                ></IonInput>
                <IonLabel position="stacked">Food Details</IonLabel>
                <IonTextarea
                  placeholder="Enter Food Details for Breakfast"
                  value={breakfastDesc}
                  rows="5"
                  type="text"
                  required
                  onIonChange={(e) => setBreakfastDesc(e.detail.value)}
                ></IonTextarea>
              </IonItem>
            </IonCol>
          </IonRow>
            ...
            <IonCol>
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  ...
                  type="text"
                  required
                  onIonChange={(e) => setLunchCal(e.detail.value)}
                ></IonInput>
                <IonLabel position="stacked">Food Details</IonLabel>
                <IonTextarea
                  placeholder="Enter Food Details for lunch"
                  rows="5"
                  value={lunchDesc}
                  type="text"
                  required
                  onIonChange={(e) => setLunchDesc(e.detail.value)}
                ></IonTextarea>
              </IonItem>
            </IonCol>
          </IonRow>
            ...
            <IonCol>
              <IonItem color="dark" id="rnd-input">
                ...
                <IonInput
                  ...
                  type="text"
                  required
                  onIonChange={(e) => setDinnerCal(e.detail.value)}
                ></IonInput>
                <IonLabel position="stacked">Food Details</IonLabel>
                <IonTextarea
                  placeholder="Enter Food Details for Dinner"
                  rows="5"
                  value={dinnerDesc}
                  type="text"
                  required
                  onIonChange={(e) => setDinnerDesc(e.detail.value)}
                ></IonTextarea>
              </IonItem>
            </IonCol>
          </IonRow>
          ...
          <IonRow>
            <IonCol>
              <IonItemDivider id="itm-divider-teal">
                <IonLabel>Evening Meal</IonLabel>
              </IonItemDivider>
            </IonCol>
          </IonRow>
          ...
          <IonRow>
            <IonCol>
              <IonItem color="dark" id="rnd-input">
                <IonLabel position="stacked">Calories</IonLabel>
                <IonInput
                  placeholder="Enter Evening Meal Calories"
                  value={supperCal}
                  type="text"
                  onIonChange={(e) => setSupperCal(e.detail.value)}
                ></IonInput>
                <IonLabel position="stacked">Food Details</IonLabel>
                <IonTextarea
                  placeholder="Enter Food Details for Evening Meal"
                  rows="5"
                  value={supperDesc}
                  type="text"
                  onIonChange={(e) => setSupperDesc(e.detail.value)}
                ></IonTextarea>
              </IonItem>
            </IonCol>
          </IonRow>
          ...
          <IonRow>
            <IonCol>
              <IonItemDivider id="itm-divider-prpl">
                <IonLabel>Daily Snacks</IonLabel>
              </IonItemDivider>
            </IonCol>
          </IonRow>
          ...
          <IonRow>
            <IonCol>
              <IonItem color="dark" id="rnd-input">
                <IonLabel position="stacked">Calories</IonLabel>
                <IonInput
                  placeholder="Enter Daily Snack Calories"
                  value={snacksCal}
                  type="text"
                  required
                  onIonChange={(e) => setSnacksCal(e.detail.value)}
                ></IonInput>
                <IonLabel position="stacked">Food Details</IonLabel>
                <IonTextarea
                  placeholder="Enter Food Details for Daily Snacks"
                  rows="5"
                  value={snacksDesc}
                  type="text"
                  required
                  onIonChange={(e) => setSnacksDesc(e.detail.value)}
                ></IonTextarea>
              </IonItem>
            </IonCol>
          </IonRow>
