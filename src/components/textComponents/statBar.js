...
const StatBar = ({timeVar, difficultyVar, dateVar,}) => {
  return (
    ...
    <IonRow>
      <IonCol size="4">
        <IonRow id="StatIcon"><IonIcon size="large" icon={calendar}></IonIcon></IonRow>
        <IonRow id="StatVar">{dateVar}</IonRow>
      </IonCol>

      <IonCol size="4">
        <IonRow id="StatIcon"><IonIcon size="large" icon={time}></IonIcon></IonRow>
        <IonRow id="StatVar">{timeVar}</IonRow>
      </IonCol>

      <IonCol size="4">
        <IonRow id="StatIcon"><IonIcon size="large" icon={flame}></IonIcon></IonRow>
